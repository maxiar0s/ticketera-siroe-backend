...
const REQUIRED_VALUES = ["Web", "Email", "Telegram IA"];
...
export const ensureTicketFuenteEnum = async () => {
  ...
  await db.query(`
    ...
    MODIFY COLUMN \`${COLUMN_NAME}\` ENUM('Web', 'Email', 'Telegram IA')
    NOT NULL DEFAULT 'Web';
  `);

  console.log(`Enum ${TABLE_NAME}.${COLUMN_NAME} actualizado con valor 'Telegram IA'.`);
};
